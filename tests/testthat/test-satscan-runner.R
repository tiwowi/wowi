...
testthat::test_that("Check if the function returns all expected outputs", {
  ### Skip test on CRAN ----
...
testthat::test_that("Check if the function returns all expected outputs from a multiple-area analysis", {
  ### Skip test on CRAN ----
  testthat::skip_on_cran()
...
testthat::test_that("Check if the function throws an error when `area = NULL` while `.by_area = TRUE`", {
  ### Skip test on CRAN ----
  testthat::skip_on_cran()
